          ...
          {success ? (
            <div style={{ textAlign: "center", padding: "20px 0" }}>
               <div style={{ 
                 ...
                 <svg width="32" height="32" viewBox="0 0 20 20" fill="var(--aurora)">
                   <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                 </svg>
               </div>
               <h2 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Signal Received</h2>
               <p style={{ color: "var(--text-secondary)" }}>Your identity has been verified. Redirecting to login...</p>
            </div>
          ) : (
            <>
              <div style={{ textAlign: "center" }}>
                ...
                <p style={{ color: "var(--text-secondary)", fontSize: 15, marginBottom: 40 }}>
                  Create your profile to explore the analytics
                </p>
              </div>
              ...
              <form onSubmit={handleSignup}>
                ...
                <div style={{ textAlign: "center", marginTop: 24 }}>
                   <p style={{ fontSize: 14, color: "var(--text-muted)" }}>
                     ...
                     <Link href="/login" style={{ color: "var(--aurora)", fontWeight: 600, textDecoration: "none" }}>
                       Sign In
                     </Link>
                   </p>
                </div>
